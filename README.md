...
[![Stack: FastAPI / React / Meilisearch](https://img.shields.io/badge/Stack-FastAPI%20%2F%20React%20%2F%20Meilisearch-009688?style=flat-square)]()
...
| `app/admin/` | Draft/validate/apply config workflow |
...
- Operator syntax: `type:exr`, `ext:mov`, `res:4k`, `date:YYYY-MM-DD..YYYY-MM-DD`
